...
###   machine setting
train_arg.add_argument('--note', type=str, default='NEWF', help="describe your model")
train_arg.add_argument('--date', type=str, default='220425', help="training model date")
...
train_arg.add_argument('--log_path', type=str, default='/AudioProject/NEWF/model/logs', help="save log path")
train_arg.add_argument('--saver_path', type=str, default='/AudioProject/NEWF/model/saver', help="save model path")
